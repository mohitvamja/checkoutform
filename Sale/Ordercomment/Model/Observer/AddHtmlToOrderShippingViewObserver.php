...
namespace Sale\Ordercomment\Model\Observer;
...
class AddHtmlToOrderShippingViewObserver implements ObserverInterface
{
    ...
    public function execute(EventObserver $observer)
    {
        if($observer->getElementName() == 'order_shipping_view')
        {
            ...
            $customorder = $order->getOrderComment();
            

            $deliveryDateBlock = $this->_objectManager->create('Magento\Framework\View\Element\Template');
            $deliveryDateBlock->setOrderComment($customorder);
            $deliveryDateBlock->setTemplate('Sale_Ordercomment::order_info_shipping_info.phtml');
